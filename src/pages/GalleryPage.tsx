...
const GalleryPage = () => {
    return (
        <div className="min-h-screen bg-white">
            {/* Hero */}
            <div className="relative bg-gradient-to-br from-violet-600 via-purple-500 to-fuchsia-500 pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <motion.p
                        ...
                        className="text-lg md:text-xl text-purple-100 max-w-3xl leading-relaxed"
                    >
            ...
            <section className="py-16 bg-gradient-to-r from-violet-600 to-fuchsia-500">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-purple-100 mb-8 max-w-2xl mx-auto">Your involvement creates ripples of positive change across communities.</p>
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <Link to="/exchange" className="px-8 py-3.5 bg-white text-violet-600 rounded-full font-bold hover:bg-violet-50 transition-colors">
                            Join the Exchange
                        </Link>
