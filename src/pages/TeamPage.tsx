...
const teamMembers: TeamMember[] = [
    ...
    },
    {
        ...
        image: '/images/team/peter_menchavez.jpg',
        initials: 'PM',
        color: 'from-blue-500 to-cyan-500',
    },
    {
        name: 'Banje A. Asingua',
        role: 'Community Health Advocate',
        bio: 'Community health advocate volunteer and a local business owner.',
        image: '/images/team/banje_a_asingua.jpg',
        initials: 'BA',
        color: 'from-indigo-500 to-blue-500',
    },
    {
        name: 'Maria Armila A. Malubay',
        role: 'Registered Nurse',
        bio: 'Registered nurse, clinic volunteer, and community health activist.',
        image: '/images/team/maria_armila_a__malubay.jpg',
        initials: 'MM',
        color: 'from-slate-500 to-slate-500',
    },
    {
        name: 'Linalyn Gabrido',
        role: 'Financial Advisor',
        bio: 'Community health advocate and a financial advisor.',
        image: '/images/team/linalyn_gabrido.jpg',
        initials: 'LG',
        color: 'from-blue-500 to-indigo-500',
    },
    {
        ...
        bio: 'Community health advocate, and former army and security personnel.',
        image: '/images/team/roy_carbonell.jpg',
        initials: 'RC',
        color: 'from-slate-500 to-slate-500',
    },
    {
        ...
        bio: 'Community health advocate, and a municipal worker.',
        image: '/images/team/marvin_asingua.jpg',
        initials: 'MA',
        color: 'from-blue-500 to-cyan-500',
    },
    {
        name: 'Ana Liza P. Eleserio',
        role: 'Community Health Advocate',
        bio: 'Dedicated community health advocate and volunteer.',
        image: '/images/team/ana_liza_p__eleserio.jpg',
        initials: 'AE',
        color: 'from-indigo-500 to-blue-500',
    },
];
