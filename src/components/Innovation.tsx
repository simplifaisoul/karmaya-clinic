                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="lg:w-1/2 relative min-h-[400px]">
                        ...
                        <div className="bg-neutral-800 rounded-3xl h-full w-full flex items-center justify-center border border-neutral-700 relative z-10 overflow-hidden group">
                            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?q=80&w=1000&auto=format&fit=crop')] bg-cover bg-center opacity-40 group-hover:scale-105 transition-transform duration-700"></div>
