...
const Contact = () => {
    return (
        <section id="contact" className="py-20 md:py-28 bg-neutral-50 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    <div>
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-5 tracking-tight">Contact Us</h2>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-neutral-900 text-sm mb-1">Locations</h4>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-neutral-900 text-sm mb-1">Email Us</h4>
                    ...
                    {/* Contact Form */}
                    <div className="bg-white p-6 md:p-8 rounded-2xl border border-neutral-100 shadow-premium">
                        <form className="space-y-5">
                            ...
                            <button type="submit" className="w-full bg-neutral-900 hover:bg-neutral-800 text-white font-semibold py-3.5 rounded-xl shadow-lg shadow-neutral-900/10 hover:shadow-xl transition-all flex items-center justify-center gap-2 text-sm">
                                Send Message
